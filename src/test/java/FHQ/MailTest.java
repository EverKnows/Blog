...
public class MailTest {
    ...
    public void test() throws MessagingException {
       ...
       // properties.setProperty("mail.debug", "true");
        ...
        //4.设置发件人
        Address fromAddr = new InternetAddress("1193932296@qq.com");
        ...
        message.setContent("<b>这是一个测试</b>", "text/html;charset=utf-8");

        //8.得到传输对象
        Transport transport = session.getTransport();
        //连接SMTP服务器
        //第一个参数是你用来发送邮件的邮箱的SMTP服务器地址，第二个是你的邮箱地址，第三个是授权码
        transport.connect("smtp.qq.com", "1193932296@qq.com", "mqqwhiohycyjieea");
    ...
    @Test
    public void test2() {
        String content = "<b>欢迎加入孵化器";
        try {
            MailUtils.sendMail("1193932296@qq.com", "767571265@qq.com", null, null, null);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
